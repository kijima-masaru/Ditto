...
export async function createTemplate(text: string, label?: string): Promise<ClipboardTemplate> {
  const templates = await listTemplates()
  const template: ClipboardTemplate = { id: randomUUID(), text, label, createdAt: new Date().toISOString() }
